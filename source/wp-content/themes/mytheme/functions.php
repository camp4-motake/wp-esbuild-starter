...
require_once "inc/cleanup-admin.php";
require_once "inc/cleanup-builtin-posts.php";
require_once "inc/constants.php";
require_once "inc/custom-post-type/news.php";
...
require_once "inc/plugin-acf-block.php";
