...
add_filter("manage_items_posts_columns", __NAMESPACE__ . "\\add_page_column_title");
add_filter("manage_materials_posts_columns", __NAMESPACE__ . "\\add_page_column_title");
add_filter("manage_news_posts_columns", __NAMESPACE__ . "\\add_page_column_title");
...
add_action("manage_items_posts_custom_column", __NAMESPACE__ . "\\add_page_column", 10, 2);
add_action("manage_materials_posts_custom_column", __NAMESPACE__ . "\\add_page_column", 10, 2);
add_action("manage_news_posts_custom_column", __NAMESPACE__ . "\\add_page_column", 10, 2);
...
// 購読者の管理画面表示を禁止
add_action("auth_redirect", __NAMESPACE__ . "\\subscriber_ignore_admin");
function subscriber_ignore_admin($user_id)
{
...
// 購読者の管理バーを表示しない
add_action("after_setup_theme", __NAMESPACE__ . "\\subscriber_hide_admin_bar");
