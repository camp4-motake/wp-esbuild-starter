...
# wp config set WPCF7_AUTOP false --raw --allow-root
...
# wp language theme install --all ja --allow-root

# import db
if [ -e /html/.db/import.sql ]; then
  wp db reset --yes --allow-root
  wp db import /html/.db/import.sql --allow-root
fi
